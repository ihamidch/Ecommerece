...
function AdminLayout() {
  return (
    <div className="animate-enter-slow flex flex-col gap-8 lg:flex-row lg:items-start">
      <aside className="w-full shrink-0 lg:sticky lg:top-24 lg:w-56">
        <div className="surface-card overflow-hidden p-3">
          ...
          <Link
            to="/"
            className="mt-4 block rounded-xl border border-slate-200 px-3 py-2 text-center text-sm font-medium text-slate-600 transition-colors hover:bg-slate-50"
          >
            ← Storefront
          </Link>
        </div>
